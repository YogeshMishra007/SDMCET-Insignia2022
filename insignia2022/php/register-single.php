<?php
    ...
    $statement->bind_param('sssssss',$_POST['participantNames'],$_POST['contactNumber'],$_POST['collegeName'],$_POST['participantUsns'],$_POST['emailId'],$_POST['accomo-check'],$_GET['id']);
